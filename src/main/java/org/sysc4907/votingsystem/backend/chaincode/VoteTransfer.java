package org.sysc4907.votingsystem.backend.chaincode;
...
public final class VoteTransfer implements ContractInterface {
    ...
    private Vote putVote(final Context ctx, final Vote vote) {
        // Use Genson to convert the Vote into string, sort it alphabetically and serialize it into a json string
    ...
    public String GetAllVotes(final Context ctx) {
        ...
        // To retrieve all votes from the ledger use getStateByRange with empty startKey & endKey.
        // Giving empty startKey & endKey is interpreted as all the keys from beginning to end.
        // As another example, if you use startKey = 'vote0', endKey = 'vote9' ,
        // then getStateByRange will retrieve vote with keys between vote0 (inclusive) and vote9 (exclusive) in lexical order.
